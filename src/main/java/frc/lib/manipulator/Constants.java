...
public final class Constants {
        ...
        public static final double INSIDE_ENTRY_INCHES = 7.0;
        public static final double INSIDE_ENTRY_DEGREES = 7.0;
        public static final double GROUND_HIT_INCHES = 8.0;
        ...
        public static final class NoFlyZones {
            ...
            public static final NoFlyZone HI_INSIDE = new NoFlyZone(INSIDE_ENTRY_INCHES,
                    INSIDE_ENTRY_DEGREES, MAX_HEIGHT_INCHES, MAX_ANGLE_DEGREES, NoFlyZone.ZoneType.Always);
        ...
        public static final class Waypoints {
            public static final Waypoint INSIDE_ENTRY = new Waypoint(INSIDE_ENTRY_INCHES, INSIDE_ENTRY_DEGREES);
