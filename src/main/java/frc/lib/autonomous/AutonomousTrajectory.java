...
public enum AutonomousTrajectory {
    ...
    LoadStation3ScoresPart1(PathPlanner.loadPathGroup("LoadStation3Scores-Part1", new PathConstraints(4.0, 2.5))),
    LoadStation3ScoresPart2(PathPlanner.loadPathGroup("LoadStation3Scores-Part2", new PathConstraints(4.0, 2.5))),
