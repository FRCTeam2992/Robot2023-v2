...
public class RobotContainer {
    ...
    private void configRealButtonBindings() {
        ...
        controller1.rightTrigger(0.6).onTrue(new SetScoringTarget(mRobotState, controller1, mElevator, mArm));
        ...
        controller1.axisGreaterThan(XboxController.Axis.kRightY.value, 0.6).whileTrue(
                new MoveElevator(mElevator, -0.4));
        controller1.leftStick().onTrue(new SetScoringTarget(mRobotState, controller1, mElevator, mArm));
